...
def get_recent_lol_matches(
    ...
    sql = f"SELECT DISTINCT match_id, match_date, duration_secs, winning_team_id AS winning_team FROM league_of_legends_matches ORDER BY match_date DESC LIMIT {limit}"
